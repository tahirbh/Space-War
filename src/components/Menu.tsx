      ...
      content: (
        <div className="flex flex-row sm:flex-col gap-2 sm:gap-4 w-full justify-center">
          <button
            onClick={onStartGame}
            className={cn(
              "group relative flex-1 sm:flex-none flex items-center justify-center gap-1.5 sm:gap-3 px-3 sm:px-8 py-2 sm:py-4",
              "bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg",
              "text-white font-bold text-[10px] sm:text-lg uppercase tracking-wider",
              "transition-all duration-300 hover:scale-105 active:scale-95",
              "border border-cyan-400/50 landscape-small-button"
            )}
          >
          ...
          <button
            ...
            className={cn(
              ...
              "text-white font-bold text-[10px] sm:text-lg uppercase tracking-wider",
              "transition-all duration-300 hover:scale-105 active:scale-95",
              "border border-pink-400/50 landscape-small-button"
            )}
          >
      ...
      content: (
        <div className="flex flex-row sm:flex-col gap-2 sm:gap-4 w-full justify-center">
          <button
            ...
            className={cn(
              "flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 py-2 sm:py-4",
              "bg-white/10 rounded-lg text-white font-medium text-[10px] sm:text-lg",
              "transition-all duration-300 hover:bg-white/20 active:scale-95",
              "border border-white/20 landscape-small-button"
            )}
          >
      ...
      content: (
        <div className="flex flex-row sm:flex-col gap-2 sm:gap-3 w-full justify-center">
          <button 
            ...
            className="flex-1 sm:flex-none px-2 py-2 bg-white/5 border border-white/10 rounded-lg text-white/80 hover:bg-white/10 text-[8px] sm:text-sm uppercase tracking-widest landscape-small-button"
          >
            Privacy
          </button>
          <button 
  ...
  return (
    <div className="h-screen h-[100svh] bg-[#0A0A15] flex flex-col items-center justify-center relative overflow-hidden select-none">
      ...
      <div className="relative z-10 flex flex-col items-center gap-[1vh] sm:gap-8 w-full max-w-4xl px-4 text-center landscape-compact-gap">
        ...
        <div className="relative w-full max-w-[300px] sm:max-w-md h-[120px] sm:h-[280px] overflow-hidden landscape-small-content-area">
          <div 
        ...
        {/* Pagination Dots */}
        <div className="flex gap-2 mt-2 sm:mt-4 landscape-hide">
          {menuPages.map((_, i) => (
            <div 
              key={i}
              className={cn(
      ...
      <div className="fixed bottom-4 sm:bottom-8 left-4 sm:left-10 z-20 transition-all duration-300">
        {currentPage > 0 && (
          <button
            ...
            className="group flex flex-col items-center gap-1 sm:gap-2 p-2 sm:p-4 text-white/40 hover:text-white transition-all active:scale-95 landscape-nav-button"
          >
            <div className="w-8 h-8 sm:w-16 sm:h-16 rounded-full border border-white/10 bg-black/40 backdrop-blur-md flex items-center justify-center group-hover:border-cyan-400 group-hover:bg-cyan-500/10 group-hover:scale-110 transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)]">
              <ChevronLeft className="w-4 h-4 sm:w-8 sm:h-8 group-hover:text-cyan-400" />
            </div>
      ...
      <div className="fixed bottom-4 sm:bottom-8 right-4 sm:right-10 z-20 transition-all duration-300">
        <button
          ...
          className="group flex flex-col items-center gap-1 sm:gap-2 p-2 sm:p-4 text-white/40 hover:text-white transition-all active:scale-95 landscape-nav-button"
        >
          <div className="w-8 h-8 sm:w-16 sm:h-16 rounded-full border border-white/10 bg-black/40 backdrop-blur-md flex items-center justify-center group-hover:border-cyan-400 group-hover:bg-cyan-500/10 group-hover:scale-110 transition-all shadow-[0_0_20px_rgba(0,212,255,0)] group-hover:shadow-[0_0_20px_rgba(0,212,255,0.2)] shadow-[0_0_15px_rgba(0,0,0,0.5)]">
            {currentPage === totalPages - 1 ? (
              <Home className="w-4 h-4 sm:w-8 sm:h-8 group-hover:text-cyan-400" />
            ) : (
              <ChevronRight className="w-4 h-4 sm:w-8 sm:h-8 group-hover:text-cyan-400 animate-pulse" />
            )}
          </div>
      ...
      <Dialog open={showHowToPlay} onOpenChange={setShowHowToPlay}>
        <DialogContent className="bg-[#0A0A15] border-cyan-500/50 text-white w-[95vw] sm:max-w-lg max-h-[90vh] overflow-y-auto p-4 sm:p-6 [&>button]:text-cyan-400 [&>button]:opacity-100 landscape-compact-gap">
          <DialogHeader>
          ...
          <div className="space-y-6 py-4 landscape-compact-gap">
            {/* Controls */}
            <div>
              <h3 className="text-lg font-bold text-cyan-400 mb-3 landscape-small-text">Controls</h3>
              <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 sm:gap-3">
                <div className="bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="text-white font-mono text-xs sm:text-base">WASD</div>
                  <div className="text-white/60 text-[10px] sm:text-sm">Move</div>
                </div>
                <div className="bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="text-white font-mono text-xs sm:text-base">Z / Space</div>
                  <div className="text-white/60 text-[10px] sm:text-sm">Shoot</div>
                </div>
                <div className="bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="text-white font-mono text-xs sm:text-base">B / Shift</div>
                  <div className="text-white/60 text-[10px] sm:text-sm">Bomb</div>
                </div>
                <div className="bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="text-white font-mono text-xs sm:text-base">Enter</div>
                  <div className="text-white/60 text-[10px] sm:text-sm">Pause</div>
                </div>
              </div>
            </div>
            ...
            {/* Power-ups */}
            <div>
              <h3 className="text-lg font-bold text-cyan-400 mb-3 landscape-small-text">Power-ups</h3>
              <div className="grid grid-cols-2 gap-2 sm:space-y-2 sm:block">
                <div className="flex items-center gap-2 sm:gap-3 bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-orange-500 flex items-center justify-center font-bold text-[10px] sm:text-base">P</div>
                  <div>
                    <div className="text-white font-medium text-[10px] sm:text-base">Power</div>
                    <div className="text-white/60 text-[8px] sm:text-sm landscape-hide">Increase shot power</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-red-500 flex items-center justify-center font-bold text-[10px] sm:text-base">B</div>
                  <div>
                    <div className="text-white font-medium text-[10px] sm:text-base">Bomb</div>
                    <div className="text-white/60 text-[8px] sm:text-sm landscape-hide">Clear screen</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-blue-500 flex items-center justify-center font-bold text-[10px] sm:text-base">S</div>
                  <div>
                    <div className="text-white font-medium text-[10px] sm:text-base">Speed</div>
                    <div className="text-white/60 text-[8px] sm:text-sm landscape-hide">Move faster</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 bg-white/5 p-2 sm:p-3 rounded-lg">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-green-500 flex items-center justify-center font-bold text-[8px] sm:text-xs">1UP</div>
                  <div>
                    <div className="text-white font-medium text-[10px] sm:text-base">Life</div>
                    <div className="text-white/60 text-[8px] sm:text-sm landscape-hide">Adds a life</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Tips */}
            <div>
              <h3 className="text-lg font-bold text-cyan-400 mb-3 landscape-hide">Tips</h3>
              <ul className="space-y-2 text-white/80 text-sm landscape-hide">
      ...
      <Dialog open={showSettings} onOpenChange={setShowSettings}>
        <DialogContent className="bg-[#0A0A15] border-cyan-500/50 text-white w-[95vw] sm:max-w-md p-4 sm:p-6 [&>button]:text-cyan-400 [&>button]:opacity-100 landscape-compact-gap overflow-y-auto max-h-[95vh]">
          ...
          <div className="space-y-4 py-4 landscape-compact-gap landscape-small-text">
            <div>
              <label className="text-white/80 text-sm mb-2 block landscape-small-text">Player Name</label>
              <input
                type="text"
                value={nameInput}
              ...
              <div className="grid grid-cols-3 gap-2">
                {(['laser', 'homing', 'booster'] as const).map((w) => (
                  <button
                    ...
                    className={cn(
                      "px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg border text-[10px] sm:text-sm capitalize transition-all landscape-small-button",
                      selectedWeapon === w 
            ...
            <div className="bg-white/5 p-2 sm:p-4 rounded-lg landscape-hide">
              <h4 className="text-white font-medium mb-2 landscape-small-text">Game Info</h4>
          ...
          <div className="flex gap-3 mt-auto">
            <button
              ...
              className="flex-1 px-4 py-2 sm:py-3 bg-white/10 rounded-lg text-white/80 hover:bg-white/20 transition-colors text-xs sm:text-base landscape-small-button"
            >
              Cancel
            </button>
            <button
              onClick={handleSaveSettings}
              className="flex-1 px-4 py-2 sm:py-3 bg-cyan-600 rounded-lg text-white font-medium hover:bg-cyan-500 transition-colors text-xs sm:text-base landscape-small-button"
            >
              Save
            </button>
          </div>
